...
const TRANSLATIONS = {
  es: {
    ...
    hero: {
      ...
      eyebrow: 'Lima, Perú · Software Engineer',
      role: 'Backend & Cloud-native · Full Stack',
      availability: 'QA Trainee · Mandu - Visma',
      cta_projects: 'Ver proyectos', cta_contact: 'Contactarme',
    ...
    about: {
      ...
      lead: 'Soy Fabricio Lopez, Ingeniero de Software en formación en la UPC y actualmente QA Trainee en Mandu - Visma. Tengo 21 años y una obsesión real por construir sistemas que funcionen de verdad — no solo que compilen, sino que resuelvan problemas, escalen bajo presión y dejen huella. Me especializo en Backend y Cloud-native, abordando cada proyecto con mentalidad de producción desde el primer commit.',
      vision_title: 'El camino que sigo',
      vision_desc: 'No construyo el roadmap para el CV. Tengo una ruta clara: Backend sólido → Cloud-native → DevSecOps → IA aplicada al producto. Todo lo que aprendo tiene un lugar en esa arquitectura.',
      value_title: 'Lo que me diferencia',
      value_desc: 'Pocos developers tienen formación simultánea en ingeniería de software, analítica de datos, finanzas y supply chain. Eso me permite entender el problema de negocio real — no solo si el test pasa.',
      philosophy_title: 'Cómo trabajo',
      philosophy_desc: 'Un MVP desplegado vale más que diez ideas en el backlog. Itero rápido, trato cada bug como información y no escribo una línea hasta entender el problema real. El código limpio es respeto, no vanidad.',
    ...
    skills: {
      ...
      box_mgmt: 'Gestión & Metodologías', box_qa: 'QA & Especialización',
    },
    certificates: {
    ...
    timeline: {
      ...
      ringent_title: 'RingentSoft — Optimización de Rutas', ringent_place: 'Proyecto Completado · Nov 2025',
      ringent_desc: 'Sistema de optimización de rutas para recolección de anchoveta con API REST y arquitectura DDD. Algoritmo de trazado adaptado a los flujos reales de pescadores. Stack: Angular + FastAPI + MySQL.',
      ...
      // Work
      mandu_title: 'QA Trainee', mandu_place: 'Mandu - Visma',
      mandu_desc: 'Prácticas pre-profesionales en el área de QA. Ejecución de pruebas manuales y funcionales, reporte y seguimiento de bugs, y participación activa en ciclos ágiles de desarrollo de software.',
    },
    contact: {
      title: 'Hablemos',
      availability: 'QA Trainee · Mandu - Visma',
  ...
  en: {
    ...
    hero: {
      subtitle: 'Software Engineer | Backend & Full Stack',
      eyebrow: 'Lima, Peru · Software Engineer',
      role: 'Backend & Cloud-native · Full Stack',
      availability: 'QA Trainee · Mandu - Visma',
    ...
    about: {
      ...
      lead: "I'm Fabricio Lopez, Software Engineering student at UPC and currently QA Trainee at Mandu - Visma. 21 years old with a genuine obsession for building systems that actually work — not just ones that compile, but ones that solve real problems, scale under pressure, and leave a mark. I specialize in Backend and Cloud-native, approaching every project with a production mindset from the first commit.",
      vision_title: 'The path I follow',
      vision_desc: 'I don\'t build roadmaps for the resume. I have a clear route: solid Backend → Cloud-native → DevSecOps → AI applied to product. Everything I learn has a concrete place in that architecture.',
      value_title: 'What sets me apart',
      value_desc: 'Few developers have simultaneous training in software engineering, data analytics, finance, and supply chain. That lets me understand the real business problem — not just whether the test passes.',
      philosophy_title: 'How I work',
      philosophy_desc: 'A deployed MVP is worth more than ten ideas in the backlog. I iterate fast, treat every bug as data, and don\'t write a line until I understand the real problem. Clean code is respect, not vanity.',
    ...
    skills: {
      ...
      box_mgmt: 'Management & Methodologies', box_qa: 'QA & Specialization',
    },
    certificates: {
    ...
    timeline: {
      ...
      ringent_title: 'RingentSoft — Route Optimization', ringent_place: 'Completed Project · Nov 2025',
      ringent_desc: 'Route optimization system for anchovy collection with REST API and DDD architecture. Custom routing algorithm adapted to real fishermen workflows. Stack: Angular + FastAPI + MySQL.',
      ...
      // Work
      mandu_title: 'QA Trainee', mandu_place: 'Mandu - Visma',
      mandu_desc: 'Pre-professional internship in QA. Manual and functional test execution, bug reporting and tracking, and active participation in agile software development cycles.',
    },
    contact: {
      title: "Let's Talk",
      availability: 'QA Trainee · Mandu - Visma',
